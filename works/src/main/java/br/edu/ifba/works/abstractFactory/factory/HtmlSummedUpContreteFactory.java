...
public class HtmlSummedUpContreteFactory implements ConfigurationAbstractFactory{
    @Override
    ...
    public ContentModel createContentModel(Works product) {
        try {
            return (ContentModel) TemplateCreator.getTemplateWithProp("HtmlSummedUp", product);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
